...
from app.common.constants import SystemConstants
from app.common.pagination import PageResult
from app.core.security import hash_password, verify_password
from app.framework.security.data_permission import apply_data_scope
...
from app.models.system import SysUser, SysUserRole, SysDept, SysRole
from app.modules.system.user.schemas import UserCreate, UserQuery, UserUpdate, UserVO
        ...
        for i, row in enumerate(data, start=2):
            try:
                ...
                self.db.add(SysUser(
                    ...
                    password=hash_password(SystemConstants.DEFAULT_PASSWORD),
                    mobile=row.get("手机号"),
                    email=row.get("邮箱"),
