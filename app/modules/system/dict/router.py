...
from app.framework.sse.manager import broadcast
from app.framework.sse.topics import DICT
from app.modules.system.dict.schemas import (
    DictCreate, DictItemCreate, DictItemUpdate, DictItemVO, DictUpdate,
)
from app.modules.system.dict.service import DictService
...
async def get_dict_page(
    ...
    from app.modules.system.dict.schemas import DictQuery
